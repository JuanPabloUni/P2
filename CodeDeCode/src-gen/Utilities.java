...
public final class Utilities {
  ...
  public static Object reverse(String s) {
    ...
    Object $result=null;
    $try:try {
      $result=$invokeMethod("toString",$invokeMethod("reverse",$invokeMethod(Utilities.class,"StringBuilder",true,null,new Object[]{s}),new Object[]{}),new Object[]{});
      if (true) break $try;
      $line=8;
  ...
  public static Object testBlock(IAutomaton M, Object testCases) {
    ...
    $try:try {
      ...
      $line=13;
      Object isTransducer=$fix($invokeMethod("isInstance",$invokeField("class",$invokeField(ITransducer.class.class,"ITransducer",true,null)),new Object[]{M}));
      $line=19;
      for (Object $v3:GCollections.unmodifiableCollection(testCases)) {
        ...
        Object r=$v4.next();
        $line=20;
        Object result=$fix($invokeMethod("acceptsString",M,new Object[]{s}));
        $line=21;
  ...
  public static Object test(IAutomaton M, String add, Boolean rev) {
    ...
    $try:try {
      ...
      while (true) {
        ...
        $line=47;
        Object string=$fix($invokeMethod("nextLine",sc,new Object[]{}));
        $line=48;
        if ($opEqualY(string,"")) {
          $line=48;
          break;
        ...
        $line=50;
        Object inputM=$fix($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{$invokeMethod("getAlphabet",M,new Object[]{})}));
        $line=52;
        if ($bool(rev)) {
          $line=53;
        ...
        $line=57;
        if ($bool($invokeMethod("containsAll",$invokeMethod("getAlphabet",M,new Object[]{}),new Object[]{string}))) {
          $line=59;
          Object result=$fix($invokeMethod("acceptsString",M,new Object[]{string}));
          $line=61;
  ...
  public static Object testR(IAutomaton M) {
    ...
    $try:try {
      ...
      while (true) {
        ...
        if ($bool($invokeMethod("containsAll",$invokeMethod("getAlphabet",M,new Object[]{}),new Object[]{string}))) {
          $line=118;
          Object result=$fix($invokeMethod("acceptsString",M,new Object[]{$opAdditY($invokeMethod(Utilities.class,"reverse",true,null,new Object[]{string}),"$")}));
          $line=119;
          System.out.println($message(new Object[]{$opAdditY($opAdditY("The string was ",(($bool(result))?("accepted!"):("rejected."))),(($bool(isTransducer))?(". Output:"):("")))}));
          $line=120;
          if ($bool(isTransducer)) {
  ...
  public static Object testCodeDecodeRevAddDS(ITransducer C, ITransducer D) {
    ...
    $try:try {
      ...
      sc=$invokeConstructor(java.util.Scanner.class,new Object[]{$invokeField("in",$invokeField(System.class,"System",true,null))});
      $line=136;
      Object inputC=$fix($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{$invokeMethod("getInputAlphabet",C,new Object[]{})}));
      $line=137;
      Object inputD=$fix($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{$invokeMethod("getInputAlphabet",D,new Object[]{})}));
      $line=139;
      ...
      while (true) {
        ...
        $line=145;
        string=$fix($invokeMethod("nextLine",sc,new Object[]{}));
        $line=146;
        if ($opEqualY(string,"")) {
          $line=146;
          break;
          ...
          while (true) {
            ...
            $line=155;
            option=$fix($invokeMethod("nextLine",sc,new Object[]{}));
          }
          $line=157;
          ...
          if (($opEqualY(option,"1")||$opEqualY(option,"2"))) {
            ...
            if ($opSbsetY($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{string}),inputC)) {
              $line=162;
              Object result=$fix($invokeMethod("acceptsString",C,new Object[]{$opAdditY(string,"$")}));
              $line=163;
              System.out.println($message(new Object[]{$opAdditY($opAdditY($opAdditY("The string was ",(($bool(result))?("accepted"):("not accepted"))),". Output: "),$invokeMethod("getOutputString",C,new Object[]{}))}));
              $line=164;
              stringOut=$fix($invokeMethod("getOutputString",C,new Object[]{}));
              $line=165;
              if ($opEqualY(option,"2")) {
                $line=166;
                if ($opSbsetY($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{stringOut}),inputD)) {
                  $line=168;
                  result=$fix($invokeMethod("acceptsString",D,new Object[]{$opAdditY($invokeMethod(Utilities.class,"reverse",true,null,new Object[]{stringOut}),"$")}));
                  $line=169;
                  Object stringOut1R=$fix($invokeMethod(Utilities.class,"reverse",true,null,new Object[]{$invokeMethod("getOutputString",D,new Object[]{})}));
                  $line=171;
                  System.out.println($message(new Object[]{$opAdditY($opAdditY($opAdditY("The Reverse of the coded string was ",(($bool(result))?("accepted"):("not accepted"))),". Output: "),$invokeMethod(Utilities.class,"reverse",true,null,new Object[]{$invokeMethod("getOutputString",D,new Object[]{})}))}));
                  $line=172;
            ...
            if ($opSbsetY($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{string}),inputD)) {
              $line=183;
              Object result=$fix($invokeMethod("acceptsString",D,new Object[]{$opAdditY($invokeMethod(Utilities.class,"reverse",true,null,new Object[]{string}),"$")}));
              $line=184;
              System.out.println($message(new Object[]{$opAdditY($opAdditY($opAdditY("The string was ",(($bool(result))?("accepted"):("not accepted")))," by the decoder. Output: "),$invokeMethod(Utilities.class,"reverse",true,null,new Object[]{$invokeMethod("getOutputString",D,new Object[]{})}))}));
            }
            else {
              $line=186;
      ...
      while (true) {
        ...
        if ($opEqualY(string,"")) {
          ...
          if (($opEqualY(option,"1")||$opEqualY(option,"2"))) {
            ...
            if ($opSbsetY($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{string}),inputC)) {
              $line=226;
              Object result=$fix($invokeMethod("acceptsString",C,new Object[]{string}));
              $line=227;
              System.out.println($message(new Object[]{$opAdditY($opAdditY($opAdditY("The string was ",(($bool(result))?("accepted"):("not accepted"))),". Output: "),$invokeMethod("getOutputString",C,new Object[]{}))}));
              $line=228;
              stringOut=$fix($invokeMethod("getOutputString",C,new Object[]{}));
              ...
              if ($opEqualY(option,"2")) {
                ...
                if ($opSbsetY($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{stringOut}),inputD)) {
                  $line=231;
                  result=$fix($invokeMethod("acceptsString",D,new Object[]{stringOut}));
                  $line=232;
                  System.out.println($message(new Object[]{$opAdditY($opAdditY($opAdditY("The coded string was ",(($bool(result))?("accepted"):("not accepted"))),". Output: "),$invokeMethod("getOutputString",D,new Object[]{}))}));
                  $line=233;
                  Object stringOut1=$fix($invokeMethod("getOutputString",D,new Object[]{}));
                  $line=234;
            ...
            if ($opSbsetY($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{string}),inputD)) {
              $line=245;
              Object result=$fix($invokeMethod("acceptsString",D,new Object[]{string}));
              $line=246;
              System.out.println($message(new Object[]{$opAdditY($opAdditY($opAdditY("The string was ",(($bool(result))?("accepted"):("not accepted")))," by the decoder. Output: "),$invokeMethod("getOutputString",D,new Object[]{}))}));
            }
            else {
              $line=248;
              System.out.println($message(new Object[]{$opAdditY("Input contains invalid symbols: ",$opDiffeY($invokeMethod(Utilities.class,"toSet",true,null,new Object[]{string}),inputD))}));
